...
for estado in estados:
    ...
    df.to_pickle(f'../data/{estado}_selected_features_all_states.pkl')
    df = pd.read_pickle(f'../data/{estado}_selected_features_all_states.pkl')
    ...
    df.to_pickle(f'../data/{estado}_treated_base_all_states.pkl')
    df = pd.read_pickle(f'../data/{estado}_treated_base_all_states.pkl')
    ...
    df.to_pickle(f'../data/{estado}_treated_base_top_causes_all_states.pkl')
